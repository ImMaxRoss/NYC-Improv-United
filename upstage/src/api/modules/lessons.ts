...
export const lessonsAPI = {
  ...
  create: (data: LessonRequest): Promise<Lesson> => api.post<Lesson>('/lessons', data),
  update: (id: number, data: LessonRequest): Promise<Lesson> => api.put<Lesson>(`/lessons/${id}`, data),
