...
public class ExerciseService {
    ...
    public Exercise updateExercise(Long exerciseId, Exercise updatedExercise, Coach coach) {
        ...
        // Can only update if: created by coach (system exercises cannot be updated)
        if (existingExercise.getCreatedBy() == null) {
            throw new IllegalArgumentException("Access denied: System exercises cannot be modified");
        }
    ...
    public Optional<Exercise> findByIdWithAccess(Long exerciseId, Coach coach) {
        ...
        if (exercise.isPresent()) {
            ...
            // Check if coach has access (public exercise, system exercise, or created by coach)
            if (ex.isPublic() || ex.getCreatedBy() == null || ex.getCreatedBy().equals(coach)) {
                return exercise;
            }
        }
    ...
    public void deleteExercise(Long exerciseId, Coach coach) {
        ...
        // Can only delete if: created by coach (system exercises cannot be deleted)
        if (exercise.getCreatedBy() == null) {
            throw new IllegalArgumentException("Access denied: System exercises cannot be deleted");
        }
    ...
    public Exercise duplicateExercise(Long exerciseId, String newName, Coach coach) {
        ...
        // Check access (public, system exercise, or created by coach)
        if (!originalExercise.isPublic() && originalExercise.getCreatedBy() != null && !originalExercise.getCreatedBy().equals(coach)) {
