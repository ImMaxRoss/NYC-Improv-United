...
('Efficiency', 'Economy of action and clarity', '#795548');
...
-- CREATE INDEX idx_lessons_upcoming ON lessons(coach_id, scheduled_date) WHERE is_template = false;
-- CREATE INDEX idx_lessons_templates ON lessons(coach_id) WHERE is_template = true;